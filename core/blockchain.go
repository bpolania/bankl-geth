...
func (bc *BlockChain) GetFilteredBlockData(blockNumber uint64) *FilteredBlockData {
...
func (bc *BlockChain) Stop() {
	...
	// Stop address filter
	if bc.blockFilter != nil && bc.blockFilter.addressFilter != nil {
		bc.blockFilter.addressFilter.Stop()
	}
