...
func TestReimportMirroredState(t *testing.T) {
	...
	chain, _ := core.NewBlockChain(rawdb.NewMemoryDatabase(), nil, genspec, nil, engine, vm.Config{}, nil, path_to_addresses)
	defer chain.Stop()
	...
	db = rawdb.NewMemoryDatabase()
	chain, _ = core.NewBlockChain(db, nil, genspec, nil, engine, vm.Config{}, nil, path_to_addresses)
	defer chain.Stop()
