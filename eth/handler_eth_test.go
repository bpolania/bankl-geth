...
func testForkIDSplit(t *testing.T, protocol uint) {
	...
	var (
		...
		chainNoFork, _  = core.NewBlockChain(dbNoFork, nil, gspecNoFork, nil, engine, vm.Config{}, nil, path_to_addresses)
		chainProFork, _ = core.NewBlockChain(dbProFork, nil, gspecProFork, nil, engine, vm.Config{}, nil, path_to_addresses)
